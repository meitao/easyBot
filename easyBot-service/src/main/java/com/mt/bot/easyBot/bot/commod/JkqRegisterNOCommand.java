...
@Component
@Slf4j
public class JkqRegisterNOCommand extends AbstractJkqRegisterCommand {

    /**
     * Construct
     */
    public JkqRegisterNOCommand() {
        super("jkqNO","With this command you can register NO jkq cert");
    }
    @Autowired
    ...
    protected String calljkq(String udid) {
        //调用极客签url
        return  jkqHttpInvoke.register_deviceNO(udid);
    }
}
