...
@Component
@Slf4j
public class JkqRegisterYYCommand extends AbstractJkqRegisterCommand {

    /**
     * Construct
     */
    public JkqRegisterYYCommand() {
        super("jkqYY","With this command you can register YY jkq cert");
    }
    @Autowired
    ...
    protected String calljkq(String udid) {
        //调用极客签url
        return  jkqHttpInvoke.register_deviceYY(udid);
    }
}
